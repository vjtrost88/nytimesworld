...
def main():
    ...
    dat = pd.read_csv('../../work/NYTimesWorld/feature-maps/vgg16_feature_map.csv', delimiter=',')
    ## Computing t-SNE
    ...
    #FINISH, FIGURE OUT
    np.savetxt("../../work/NYTimesWorld/feature-maps/t-sne-out-vgg16-feature-map.csv", X_tsne, delimiter=',')
